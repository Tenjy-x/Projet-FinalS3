...
// Define directory separator if not already defined
...
$app->set('flight.base_url', '/ETU003920/Projet-FinalS3');           // Base URL for your app. Change if app is in a subdirectory (e.g., '/myapp/')
